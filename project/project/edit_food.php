...
<body>
	<div class="container">
      <button class="btn btn-info  mt-5 px-5 ml-5"><a class="text-white" href="edit_chienes.php" >Chinese Food</a></button><br>
         <button class="btn btn-info  mt-5 px-5 ml-5"><a class="text-white" href="edit_korean.php" > Korean  Food</a></button><br>
            <button class="btn btn-info  mt-5 px-5 ml-5"><a class="text-white" href="_japanese.php" >Japanese Food</a></button><br>
